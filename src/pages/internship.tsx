...
import Grad1 from "../assets/images/internship/grad.jpg";
import Grad2 from "../assets/images/internship/mim.png";
          ...
          <div className="w-full max-w-7xl m-auto items-center flex justify-center">
            <section className="space-y-4">
              <div className="text-2xl font-bold text-black text-center">
                RECENTLY GRADUATED? WHY NOT JOIN US AT UC
                      ...
                      <div className="h-[100%] w-[100%]  grid xl:justify-center xl:py-5 py-0 xl:items-start lg:items-center items-start">
                        ...
                        <div className={Styles.ButtonContainer}>
                          <button
                            onClick={() =>
                              window.open(
                                "https://docs.google.com/forms/d/e/1FAIpQLSevWAoF48B8DeSlrXSwKpgW77rZ8XYWmXWt3bNrDxeYZMz5UQ/viewform?usp=sf_link",
                                "_blank",
              ...
              <div className={StylesHome.Grid4}>
                <div className={StylesHome.Grid4Items}>
                  <Box
                    ...
                    description={
                      <div>
                        Do you want to gain professional experience working hand
                        in hand with Higher Education institutions? Come join us
                      </div>
                    }
                    link=""
